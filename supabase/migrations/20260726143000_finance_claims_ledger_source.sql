-- Use the auditable finance_claims ledger as the source of truth for paid claims.
-- This prevents stale school_config.finance_settled_students values from making
-- a newly completed/paid student appear already claimed.
