-- Transactional school tenant creation/update used only by the protected Edge Function.
...
begin
  ...
  if action_name = 'create' then
    insert into public.schools (
      code, school_code, name, phone, email,
